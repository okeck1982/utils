...
# Get informations
read -p "Admin Username (administrator): " ADMINUSER
read -p "IP Address: " NEW_IP
read -p "Netmaks (255.255.255.0): " NEW_MASK
read -p "Gateway: " NEW_GW
read -p "DNS Server (10.10.100.11): " NEW_DNS
read -p "New Domain (ok.home): " NEW_DOMAIN
...
EOF
read -p "Execute changes? (y/n)" CONFIRM
...
cat << EOF > /home/administrator/interfaces
